    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="row" id="sum">
          <div class="col-sm-12"> <span>Credits <span class="credits"><?=$client['credits'] ?> PHP</span></span> </div>
    ...
    function setdoc(node,f){
      ...
      $.ajax({
          ...
          success:(res)=>{
            ...
            $('#bwpages').html(`<span>Detected BW pages: ${res.bw_counter} pages (${bwpages.join(', ')} )</span>`)
            $('#colpages').html(`<span>Detected Colored pages: ${res.colored} pages (${colpages.join(', ')} )</span>`)
            compute();
